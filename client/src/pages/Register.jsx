    ...
    <section className="w-full container mx-auto px-2">
      ...
      <form action="" className="grid gap-4 mt-6" onSubmit={handleSubmit}>
        ...
        <div className="grid gap-1">
          ...
          <button 
          type="submit"
          disabled={!validValue} className={`${validValue ? "bg-green-600 hover:bg-green-500 text-white py-2 rounded font-semibold my-2 tracking-wide" : "bg-gray-500 text-white py-2 rounded font-semibold my-2 tracking-wide"}`} >Register</button>
      </form>
